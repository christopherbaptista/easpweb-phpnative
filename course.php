                    ...
                    <div class="mb-5">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight">Course</h1>
                            </div>
                            <!-- Actions -->
                        ...
                        <div class="nav nav-tabs mt-4 overflow-x border-0">
                            <?php if (in_array("admin", $_SESSION['admin_akses']) || in_array("guru", $_SESSION['admin_akses'])) { ?>
                                <a href="form_simpan.php" class="d-inline-flex mx-1" style="color: #95CD41">
                                    <span class=" pe-2">
                            ...
                            <table class="table table-hover table-nowrap">
                                ...
                                <tbody>
                                    <?php
                                        // Load file koneksi.php
                                        include "koneksi.php";
                                        // Buat query untuk menampilkan semua data mapel
                                        $sql = $koneksi->prepare("SELECT * FROM mapel");
                                        ...
                                        while($data = $sql->fetch()){ // Ambil semua data dari hasil eksekusi $sql
                                            ...
                                            echo "
                                            <td>
                                                <img alt=\"...\" src=\"https://image.flaticon.com/icons/png/512/1089/1089129.png\" class=\"avatar avatar-sm rounded-circle me-2\">
                                                <a class=\"text-heading font-semibold\" href=\"#\">
                                                    ".$data['nama_guru']."
                                                </a>
                                            </td>";
                                            
                                            if ( $data['mapel_status'] == "Scheduled" ) { 
                                                echo "
                                                <td>
                                                    <span class=\"badge badge-lg badge-dot\">
                                                        <i class=\"bg-success\"></i>".$data['mapel_status']."
                                                    </span>
                                                </td>";
                                            } else if ( $data['mapel_status'] == "Postponed" ) { 
                                                echo "
                                                <td>
                                                    <span class=\"badge badge-lg badge-dot\">
                                                        <i class=\"bg-warning\"></i>".$data['mapel_status']."
                                                    </span>
                                                </td>";
                                            } else if ( $data['mapel_status'] == "Asynchronous" ) { 
                                                echo "
                                                <td>
                                                    <span class=\"badge badge-lg badge-dot\">
                                                        <i class=\"bg-dark\"></i>".$data['mapel_status']."
                                                    </span>
                                                </td>";
                                            } else { 
                                                echo "
                                                <td>
                                                    <span class=\"badge badge-lg badge-dot\">
                                                        <i class=\"bg-danger\"></i>".$data['mapel_status']."
                                                    </span>
                                                </td>";
                                            }

                                            if (in_array("admin", $_SESSION['admin_akses']) || in_array("guru", $_SESSION['admin_akses'])) {
                                                echo "
                                                <td class=\"text-end\">
                                                    <a href='form_ubah.php?id=".$data['id']."' class=\"btn d-inline-flex btn-sm btn-neutral border-base mx-1\">
                                                        <span class=\" pe-2\">
