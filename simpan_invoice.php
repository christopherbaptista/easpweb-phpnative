...
<body>
<div class="container">  
  <form id="styling" method="post" action="invoice_simpan.php" enctype="multipart/form-data">
    <h3>Tambah Data Tagihan Orang Tua</h3>
    <fieldset>
        <p>Invoice Details</p>
        <input placeholder="Nama Tagihan"  type="text" name="nama_invoice" tabindex="1" required autofocus>
    </fieldset>
    <fieldset>
        <p>Invoice Amount</p>
        <input placeholder="Total Tagihan" type="number" name="jumlah" tabindex="2" required>
    </fieldset>
    <fieldset>
        <p>Due Date</p>
        <input placeholder="Tanggal Jatuh Tempo" type="date" name="tanggal" tabindex="3" required>
    </fieldset>
    <fieldset>
        <p>Status</p>
