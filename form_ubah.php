...
<div class="container">  
    <?php
        ...
        $sql = $koneksi->prepare("SELECT * FROM mapel WHERE id=:id");
        $sql->bindParam(':id', $id);
    ...
    <fieldset>
        <p>Course Details</p>
        <input placeholder="Nama Mata Pelajaran"  type="text" name="nama_mapel" value="<?php echo $data['nama_mapel']; ?>" tabindex="1" required autofocus>
    </fieldset>
    <fieldset>
        <p>Date</p>
        <input placeholder="Masukkan Tanggal" type="date" name="tanggal" value="<?php echo $data['tanggal']; ?>" tabindex="2" required>
    </fieldset>
    <fieldset>
        <p>Teacher Name</p>
        <input placeholder="Nama Guru" type="text" name="nama_guru" value="<?php echo $data['nama_guru']; ?>" tabindex="3" required>
    </fieldset>
    <fieldset>
        <p>Status</p>
        <?php
        if($data['mapel_status']) {
          echo "
          <select for=\"mapel_status\" name=\"mapel_status\">
            <option>
                Scheduled
            </option>
            <option>
    ...
    <fieldset>
        ...
        <button class="btn" onclick="location.href='course.php'" type="button" value="Batal">Batal</button>
    </fieldset>
  </form>
  <div>
